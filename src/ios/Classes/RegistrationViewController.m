...
- (IBAction)registrationDone:(id)sender
{
    ...
    id<Response> response = [ServiceProxy registerAccount:self.emailTextField.text withDeviceToken:appDelegate.deviceToken];
    ...
    if (!response.success) {
        ...
        NSArray* appointments = (NSArray*)response.payload;
