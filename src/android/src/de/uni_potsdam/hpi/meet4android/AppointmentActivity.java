        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                try {
                    ...
                    int appId = service.createAppointment(user, self.dloc, what.getText().toString(), emails,
                            TravelPlan.TravelType.PublicTransport);
                    Intent intent = new Intent(self, AppointmentShowActivity.class);
                    AppointmentShowActivity.setAppointment(intent, service.getAppointment(appId));
